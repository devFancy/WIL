...
> 이 글은 [자바 개발자를 위한 코틀린 입문](https://www.inflearn.com/course/java-to-kotlin/dashboard) 강의를 듣고 정리한 내용입니다.
...
<img src="img/java-to-kotlin/kotlin-9-1.png">

<img src="img/java-to-kotlin/kotlin-9-2.png">

2. 생성자와 init

- 주생성자 - 반드시 존재, 단 주생성자에 파라미터가 하나도 없으면 생략 가능

<img src="img/java-to-kotlin/kotlin-9-3.png">

- 부생성자 - 있을수 있고, 없을 수 있다.
- **최종적**으로 주생성자를 this로 호출해야 한다. → body를 가질 수 있다.

<img src="img/java-to-kotlin/kotlin-9-4.png">
...
- 왜 field를 사용하는 걸까?
   ...
   <img src="img/java-to-kotlin/kotlin-9-5.png">

- name은 getter를 부른다 ⇒ 무한루프 발생

  <img src="img/java-to-kotlin/kotlin-9-6.png">

- 무한루프 막기위한 예약어

  <img src="img/java-to-kotlin/kotlin-9-7.png">
...
<img src="img/java-to-kotlin/kotlin-10-1.png">
...
<img src="img/java-to-kotlin/kotlin-10-2.png">
...
1. 자바와 코틀린의 가시성 제어
   ...
   <img src="img/java-to-kotlin/kotlin-11-1.png">
...
2. 코틀린 파일의 접근 제어
   ...
   <img src="img/java-to-kotlin/kotlin-11-2.png">
...
3. 다양한 구성요소의 접근 제어 - 클래스, 생성자, 프로퍼티
   ...
   <img src="img/java-to-kotlin/kotlin-11-3.png">

   <img src="img/java-to-kotlin/kotlin-11-4.png">
...
1. 중첩 클래스의 종류
   ...
   <img src="img/java-to-kotlin/kotlin-13-1.png">

    - static 클래스, 내부 클래스 그림으로 정리

   <img src="img/java-to-kotlin/kotlin-13-2.png">
...
<img src ="img/java-to-kotlin/kotlin-15-1.png">  
...
- ? 위치에 따라 null 의미가 달라진다.
  ...
  <img src="img/java-to-kotlin/kotlin-15-2.png">

    - Java는 nullable 타입과 non-nullable 타입을 구분하지 않는다.

  <img src="img/java-to-kotlin/kotlin-15-3.png">
  ...
  <img src="img/java-to-kotlin/kotlin-15-4.png">
...
<img src="img/java-to-kotlin/kotlin-16-1.png">
...
- 형식: `변수 함수이름 argument`
  ...
  <img src="img/java-to-kotlin/kotlin-16-2.png">
...
- 정의: 함수가 호출되는 대신, 함수를 호출한 지점에 함수 본문을 그대로 복붙하고 싶은 경우 사용한다.
  ...
  <img src="img/java-to-kotlin/kotlin-16-3.png">
...
- 예시: 함수로 추출하면 좋은데, 이 함수를 **지금 함수 내에서만 사용하고 싶을 경우**
  ...
  <img src="img/java-to-kotlin/kotlin-16-4.png">
...
- 그래서 JDK8부터는 람다 (이름이 없는 함수)가 등장하게 되었다.
  ...
  <img src="img/java-to-kotlin/kotlin-17-1.png">

- 또한, 반복문과 if문을 간결하게 하기 위해 스트림이 등장하게 되었다. (병렬 처리에도 강점이 있음)

  <img src="img/java-to-kotlin/kotlin-17-2.png">
...
- 람다를 만드는 방법 (실제로는 두번째 방법을 많이 사용함)
  ...
  <img src="img/java-to-kotlin/kotlin-17-3.png">

- 또한 함수의 타입은 아래와 같이 표기한다.

  <img src="img/java-to-kotlin/kotlin-17-4.png">

- 코틀린은 함수 자체를 1급 시민으로 간주해서 변수에 넣을 수도 있고, 파라미터에 넣을 수도 있다.
- 그래서 이 함수 타입 자체가 함수 그 자체를 받는다.

  <img src="img/java-to-kotlin/kotlin-17-5.png">

#### 3. Closure

- Java에서는 람다를 쓸 때 사용할 수 있는 변수에 제약이 있다.

  <img src="img/java-to-kotlin/kotlin-17-6.png">

- 하지만 코틀린에서는 아무런 문제 없이 동작한다.

  <img src="img/java-to-kotlin/kotlin-17-7.png">
...
#### 4. 다시 try with resources
  ...
  <img src="img/java-to-kotlin/kotlin-17-8.png">

- use 를 타고 들어가게 되면 아래와 같은 시그니처가 나온다.

  <img src="img/java-to-kotlin/kotlin-17-9.png">
