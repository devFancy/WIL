...
![](../img/company/tossbank/tossbank_squad.png)
...
![](../img/company/tossbank/tossbank_organization_202503.png)
...
- 주요 조직 구성
    ...
    - 특징:
      - 'AI실', 'AI기술실', 'AI서비스본부' 등을 별도로 두어 AI 기술 내재화에 집중하고 있다.
      - 현재 경영전략그룹의 '글로벌본부' 산하에 국가별 현지화를 전담하는 별도 `테크` 챕터가 신설될 것으로 예측된다.
