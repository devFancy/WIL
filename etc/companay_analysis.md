...
- [카카오뱅크](#카카오뱅크)
    ...
    - [참고자료](#참고자료-1)
- [카카오페이손해보험](#카카오페이손해보험)
    - [1. 어떤 비전을 가지고 있나요?](#1-어떤-비전을-가지고-있나요-2)
    - [2. 어떤 방식으로 일을 하나요?](#2-어떤-방식으로-일을-하나요-2)
    - [3. 어떤 서비스를 운영하고 있나요?](#3-어떤-서비스를-운영하고-있나요-2)
    - [4. 각 서비스의 조직도를 직접 예측해 보세요.](#4-각-서비스의-조직도를-직접-예측해-보세요-2)
    - [기타. 지배구조도](#기타-지배구조도)
    - [참고자료](#참고자료-2)
...
![](../img/company/tossbank/tossbank.jpeg)
...
<img src="../img/company/tossbank/tossbank_service_1.jpg" width="40%" alt="tossbank_service_1">

### 예적금/목돈 굴리기

<img src="../img/company/tossbank/tossbank_service_2.jpg" width="40%" alt="tossbank_service_2">

### 대출/갈아타기

<img src="../img/company/tossbank/tossbank_service_3.jpg" width="40%" alt="tossbank_service_3">

### 신용카드/체크카드/서비스

<img src="../img/company/tossbank/tossbank_service_4.jpg" width="40%" alt="tossbank_service_4>
...
<img src="../img/company/tossbank/tossbank_organization_chart.png" width="40%" alt="tossbank_organization_chart">
...
- 토스의 자회사 지분율 비교
    ...
    - 토스페이먼츠: 58.5%
    - **토스뱅크: 28.4% (유독 낮음)**
      ![](../img/company/tossbank/tossbank_corporate_governance.png)
...
![](../img/company/kakaobank/kakaobank.png)
...
![](../img/company/kakaobank/kakaobank_service.png)
...
- 최근(2025년) - ‘지우개’서비스, AI 이체 서비스, 광고보고 현금받기(8월), 돈버는 재미(9월), 우리아이서비스(9월)
    - ![](../img/company/kakaobank/kakaobank_new_service_2025_3Q.png)
...
![](../img/company/kakaobank/kakaobank_organization.png)
...
1. 제2의 수익원 확립: 개인사업자 대출 확대
    ...
    - 가계 대출 중심의 포트폴리오 한계를 극복하고, 기업 금융 시장으로 진출하여 새로운 성장 동력(매출)을 확보하려는 시도.
      ![](../img/company/kakaobank/kakaobank_banking_biz.png)
...
3. 기술 혁신: 금융 IT + AI 기술 접목
    ...
    - 망 분리 환경 내에서 sLLM(경량화 거대언어모델)을 적용하여, 금융 보안을 지키면서도 `개인화된 금융 비서` 경험을 제공.
      ![](../img/company/kakaobank/kakaobank_ai_service_2025_4Q.png)

4. 기반 트래픽 확대: 모임통장과 포용 금융
    - 모임통장 유저 수 1,200만 명 돌파 (2024. 3Q 대비 11% 성장).
      ![](../img/company/kakaobank/kakaobank_meeting_account_4Q.png)
...
![](../img/company/kakaopayinsurance/kakaopay_insurance.jpg)
...
![](../img/company/kakaopayinsurance/kakaopayinsurance_service.png)
...
![](../img/company/kakaopayinsurance/kakaopay_corporate_governance.png)
