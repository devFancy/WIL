...
- [3장. 함수 정의와 호출](#3장-함수-정의와-호출)
  ...
  - [코드 깔끔하게 다루기: 로컬 함수와 확장](#코드-깔끔하게-다루기-로컬-함수와-확장)
  - [배운 점](#배운-점)
- [4장. 클래스, 객체, 인터페이스](#4장-클래스-객체-인터페이스)
  - [클래스 계층 정의](#클래스-계층-정의)
  - [클래스 선언](#클래스-선언)
  - [컴파일러가 생성한 메서드: data 클래스와 클래스 위임](#컴파일러가-생성한-메서드-data-클래스와-클래스-위임)
  - [object 키워드: 클래스 선언과 인스턴스 생성을 한번에 하기](#object-키워드-클래스-선언과-인스턴스-생성을-한번에-하기)
  - [인라인 클래스](#인라인-클래스)
  - [배운 점](#배운-점-1)
